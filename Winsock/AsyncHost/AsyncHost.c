...
#define ID_BTN_QUERY	2 /* 查询按钮的ID */

#define HOST_BUF_LEN	1024 /* 缓冲区长度 */
#define HOST_POS_X		60   /* 输出信息左上角x位置 */
#define HOST_POS_Y		80	 /* 输出信息左上角y位置 */
		...
		PSTR szCmdLine, int iCmdShow)
{
	...
	wndclass.lpszClassName	= szClassName;	/* 窗口名字 */
	...
	WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		/* 初始化 */
		SetWindowText(hWndWgt[ID_EDIT_HOST], TEXT("www.google.con"));
		return 0;
